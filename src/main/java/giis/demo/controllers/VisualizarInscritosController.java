...
public class VisualizarInscritosController {
	...
	public void mostrarCursos () {
		List<CursosDTO> cursos = model.getListaCursos();
	...
	public void getListaEspera() {
		List<InscripcionesDTO> inscripcionesEspera = model.getListaEspera((int) view.getTablaCursos().getValueAt(view.getTablaCursos().getSelectedRow(), 0));
