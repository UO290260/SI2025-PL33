...
public class PeritosDTO {
	...
	public PeritosDTO(int tap, int id, String correo, int telf, String est) {
		this.setTap(tap);
	...
	public int getId_colegiado() { return id_colegiado; } 
	...
	public void setTap(int tap) { this.tap = tap; }
